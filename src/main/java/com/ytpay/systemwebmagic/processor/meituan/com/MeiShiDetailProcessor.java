 ...
 */
@Component
public class MeiShiDetailProcessor implements PageProcessor {
    ...
    @Autowired
    private MeiShiDetailProcessor meiShiDetailProcessor;
...
//            });
    ...
    public static void main(String args[]) {
        Spider.create(new MeiShiDetailProcessor().setInit(false))
    ...
    public MeiShiDetailProcessor setInit(boolean init) {
        this.init = init;
        return this;
    }
