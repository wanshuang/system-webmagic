 ...
 */
@Component
public class MeiShiDetailProcessorThird implements PageProcessor {
    ...
    @Autowired
    private MeiShiDetailProcessorThird meiShiDetailProcessor;
...
//            });
    ...
    public static void main(String args[]) {
        Spider.create(new MeiShiDetailProcessorThird().setInit(false))
    ...
    public MeiShiDetailProcessorThird setInit(boolean init) {
        this.init = init;
        return this;
    }
